...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000006027b0d0d4ad9b70b5702f6661d5e98fec01f5832a9ab00fba6627aee9b"));
...
public:
    CMainParams()
    {
        ...
        nMaxMoneyOut                     = 10 * 1000 * 1000 * COIN;
        nCollateral                      = 10000 * COIN;
        ...
        const char* pszTimestamp         = "1 Jan 2019, Confusion continues as immigrant children remain separated from parents!!!";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig           = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue             = 0 * COIN;
        txNew.vout[0].scriptPubKey       = CScript() << ParseHex("046ab988f7928ed7072c5d17b7d48fe7455129e379b3aea1c70c1e130c8e62cc7106989e5f29e7d14bc2a4a7cf0553809d181e891805e92a0bc7e0b517018bd263") << OP_CHECKSIG;
...
*/
        ...
        assert(hashGenesisBlock       == uint256("0x000006027b0d0d4ad9b70b5702f6661d5e98fec01f5832a9ab00fba6627aee9b"));
        assert(genesis.hashMerkleRoot == uint256("0x48b54dac1c9e42f2f64713767baf948e1f4a0d48fb90494205db4dfe5a818c36"));

        vSeeds.push_back(CDNSSeedData("seed1", "seed1.blastexchange.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.blastexchange.com"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.blastexchange.com"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.blastexchange.com"));
        ...
        vTreasuryRewardAddress           = "BKsZDkou7Y7fBtpvk9vURHHF9hT2FQYcAc";
        nStartMasternodePayments         = 1546300800;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads                  = 0;
        nTargetTimespan                = 1 * 60; // BlastX: 1 day
        nTargetSpacing                 = 1 * 15;  // BlastX: 15 seconds
        nLastPOWBlock                  = 3000;
        nMaturity                      = 2;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 85); // Testnet blastx addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 87);  // Testnet blastx script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY]     = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet blastx BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet blastx BIP32 prvkeys start with 'DRKP'
        ...
        strSporkKey                    = "0407ed0b5a738a63e7870c90683fc79d718532f4162bfb12c95b406e3fc56cfeea8d1fe3d74665cfd15b2b9d3e725653fe64bacdf5f55ccb832bd3ffddc14f32e5";
        strObfuscationPoolDummyAddress = "bXux98pGwbHi535TDbd2QS6mRL4NDvRXhD";
        vTreasuryRewardAddress         = "bXux98pGwbHi535TDbd2QS6mRL4NDvRXhD";
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 1 * 60;        // BlastX: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1546301000;
        genesis.nBits = 0x1e0ffff0;
