                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BLAST from zBLAST"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBLAST"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBLAST));
