...
public:
    ...
    void setZBLASTControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBLAST_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBLAST_clicked();
    void on_pushButtonZBLASTControl_clicked();
