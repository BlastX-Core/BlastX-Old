...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total blastx balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zBLASTsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zBLAST denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zBLAST denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zBLAST denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBLAST denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBLAST denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBLAST denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBLAST denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zBLAST denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zBLAST denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in blastx/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in blastx/kb\n"
    ...
    obj.emplace_back(Pair("zBLASTsupply", zcivObj));
...
Value mnsync(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1 || (strMode != "status" && strMode != "reset" && strMode != "next")) {
        throw runtime_error(
            ...
            "\nReturns the sync status or resets sync or go to next asset.\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"blastxaddress\"\n"
            "\nReturn information about the given blastx address.\n"
            "\nArguments:\n"
            "1. \"blastxaddress\"     (string, required) The blastx address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"blastxaddress\", (string) The blastx address validated\n"
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are blastx addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) blastx address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"blastxaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"blastxaddress\"  (string, required) The blastx address to use for the signature.\n"
