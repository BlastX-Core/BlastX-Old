/* src/config/blastx-config.h.  Generated from blastx-config.h.in by configure.  */
/* src/config/blastx-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BLAST_CONFIG_H

#define BLAST_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.blastexchange.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BlastX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BlastX Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blastx"
